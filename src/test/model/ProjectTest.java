...
public class ProjectTest {
    ...
    public void setup() {
        ...
        leaf1 = new LeafTask("Leaf Task 1", "Test Description L1", new Date(1, 1, 2026), 10, 0, null);
        leaf2 = new LeafTask("Leaf Task 2", "Test Description L2", new Date(2, 1, 2026), 5, 2, branch1);
        leaf3 = new LeafTask("Leaf Task 3", "Test Description L3", new Date(3, 1, 2026), 10, 2, branch1);
        ArrayList<Task> subtasks1 = new ArrayList<>();
        subtasks1.add(leaf2);
        subtasks1.add(leaf3);
        branch1 = new BranchTask("Branch Task 1", "Test Description B1", subtasks1, 1, branch2);
        ArrayList<Task> subtasks2 = new ArrayList<>();
        subtasks2.add(branch1);
        branch2 = new BranchTask("Branch Task 2", "Test Description B2", subtasks2, 0, null);
    }
